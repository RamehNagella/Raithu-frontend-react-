...
const NavBar = () => {
  ...
  return (
    ...
    >
      <div className="navbar bg-base-100/80 px-4 min-h-[100px] items-center">
        ...
        <div className="flex-1 text-center text-orange-600">
          <h1
            ...
            style={{ textShadow: "2px 2px 6px yellow" }}
          >
            Raithu
          </h1>
          <p
            className="text-sm font-bold text-violet-700 tracking-wide"
            style={{
        ...
        <div className="flex items-center gap-2 w-auto">
          <div
            className={`text-sm font-bold ${
              user?.user?.firstName ? "text-violet-900" : "text-gray-200"
            }`}
          >
            {user?.user?.firstName
          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <div className="w-12 rounded-full">
                <img alt="user" src={user?.user?.photoUrl || defaultIcon} />
              </div>
            </div>

            <ul className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[2000] mt-3 w-52 p-2 shadow">
              {user?.user?.emailId ? (
                <>
                  <li>
  ...
  // return (
  //   <div
  //     className="navbar-fixed bg-base-100 shadow-md"
...
// <div className="navbar bg-base-100/80  px-4 min-h-[90px]">
//   {/* LEFT SIDE - TITLE */}
//   <div className="flex-1 relative text-orange-600">
//     <div className="flex flex-col justify-center">
//       <h1
//         className="text-3xl font-bold absolute left-[35%] -top-7"
//         style={{ textShadow: "2px 2px 6px yellow" }}
//       >
//         Raithu
//       </h1>
//       <p
//         className="text-sm font-bold text-violet-700 tracking-wide absolute left-[45%] top-1"
//         style={{
//           textShadow: "0 0 5px yellow, 0 0 10px gold",
//         }}
//       >
...
//       style={{
//         fontFamily: "ui-monospace",
//         textShadow: user?.user?.firstName
//           ? "1px 1px 3px orange, 0 0 7px yellow"
//           : "0 0 3px red, 0 0 3px white",
//       }}
//     >
